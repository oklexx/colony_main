...
out = r"C:\Users\oklex\OneDrive\Documentos\sakhalin_colony_main\extracted4"
...
def walk(dire, path, depth):
    for e in dire.entries:
        ...
        if hasattr(e, "directory") and e.directory:
            ...
            data = raw[off:off+ln]
            p = "_".join(path)
            fn = os.path.join(out, "%s_%d.bin" % (p, depth))
