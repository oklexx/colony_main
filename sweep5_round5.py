...
BASE = {
    ...
    "net_arch": [256, 256], "map_size": 100,
    "curriculum_schedule": [],
    "build_bonus": 25.0, "chain_bonus": 1.0, "chain_daily": 0.5,
    "novelty": 15.0, "daily_income": 15.0, "sale_bonus": 2.0,
...
CONFIGS = [
    {"name": "R5_0_s2_base", "desc": "stage=2, inc15",
     "curriculum_stage": 2},
    {"name": "R5_1_s2_born10", "desc": "stage=2, born=10",
     "curriculum_stage": 2, "born_bonus": 10.0, "milestone_people_bonus": 10.0},
    {"name": "R5_2_s2_pop", "desc": "stage=2, born=15, survival=5",
     "curriculum_stage": 2, "born_bonus": 15.0, "survival_bonus": 5.0,
     "milestone_people_bonus": 15.0},
    {"name": "R5_3_s1_pop", "desc": "stage=1, born=15, inc20, death=0",
     "born_bonus": 15.0, "survival_bonus": 5.0,
     "milestone_people_bonus": 15.0, "daily_income": 20.0,
     "death_penalty": 0.0},
]
...
def main():
    ...
    if valid:
        ...
        print(f"Closest: {best['name']}: return={best.get('eval_return')} score={best.get('eval_score')} bases={best.get('eval_bases')}")
